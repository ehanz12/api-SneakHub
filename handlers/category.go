...
func CategoryCreateHandler(c *fiber.Ctx) error {
	...
	return c.Status(201).JSON(fiber.Map{"status": "true", "message": "berhasil membuat category", "data": mappers.ToCategoryRes(category)})
}
...
func GetCategoryHandler(c *fiber.Ctx) error {
	...
	return c.Status(200).JSON(fiber.Map{"status": "true", "message": "success memuat category", "data": mappers.ListToCategoryResponse(category)})
}
...
func UpdateCategoryHandler(c *fiber.Ctx) error {
	...
	return c.Status(200).JSON(fiber.Map{"status": "true", "message": "berhasil update category", "data": mappers.ToCategoryRes(category)})
}
...
func DeleteCategoryHandler(c *fiber.Ctx) error {
	...
	return c.Status(200).JSON(fiber.Map{"status": "true", "message": "berhasil menghapus category", "data": nil})
}
